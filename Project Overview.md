...
Enroll in courses
Watch video lectures
Download PDFs / notes / assignments
Attempt quizzes/tests
View marks / progress dashboard
Receive notifications for assignments and course updates
Instructor Features
Instructor login
Upload lecture videos, PDFs, assignments, quizzes
Manage courses and student batches
View student performance
Admin Features
Manage users (students/instructors)
Approve or create courses
Monitor application health
Track storage usage and traffic
...
Example flow:
Instructor uploads lecture file to S3
S3 event triggers Lambda
Lambda validates file, stores metadata in DynamoDB/RDS, and sends a success log to CloudWatch
Why Lambda?
serverless
...
Student opens EduStream website
Request reaches Application Load Balancer
ALB forwards request to one of the EC2 application servers
EC2 fetches course details from RDS
video/PDF content URL is read from S3
student watches/downloads content
progress may be updated in RDS or DynamoDB
logs and metrics are sent to CloudWatch
Use Case: Instructor Uploads a Video
Instructor logs in to portal
Uploads lecture video
Application stores file in S3
S3 event triggers Lambda
Lambda validates file / stores metadata / updates content status
Lambda writes logs to CloudWatch
students can then access the content
